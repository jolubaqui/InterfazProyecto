                        ...
                        <div class="col bg d-none d-lg-block col-md-5 col-lg-5 col-xl-6 rounded"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="?controlador=egresados&accion=crear"><span>¿No tienes cuenta? <a href="?controlador=egresados&accion=crear">Registrate</a></span></a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="?controlador=egresados&accion=login">¿Ya tienes una cuenta? Ingresa!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
